...
{
public int New_ (VirtualDeckGenNHibernate.Enumerated.VirtualDeck.CardTypeEnum p_type, VirtualDeckGenNHibernate.Enumerated.VirtualDeck.CardRarityEnum p_rarity, int p_speed, int p_defense, int p_attack, int p_health, string p_name, string p_img, System.Collections.Generic.IList<int> p_attackMoves, int p_card)
{
