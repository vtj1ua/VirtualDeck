...
public static void InitializeData ()
{
        ...
        try
        {
                ...
                int cartaPrueba = cardCEN.New_ ("Creaocasos", "Dragon antiguo basado en el choque del cielo y la tierra", 2000, "urlAlAImagen", CardTypeEnum.Dragon, 100, 90, 50, 70, CardRarityEnum.Mythical, new List<int> { idAttack1, idAttack2, idAttack3 });
